...
var MODULE = (function () {
  ...
  function initView() {
    ...
    if (app.currentView.querySelector(".navItem")) {
      ...
      // else if(linkName == "study.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[2]);
      // }
      ...
      // else if(linkName == "innerSubject.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[1]);
      // }
      // else if(linkName == "innerSubjectTwo.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[1]);
      // }
      // else if(linkName == "subjectTopic.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[0]);
      // }
      // else if(linkName == "subjectTopicVideo.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[0]);
      // }
      // else if(linkName == "readDocument.html"){
      //   app.updateNavItems();
      //   focusActiveButton(app.navItems[0]);
      // }
...
<div id="generatedList" class="list">\
    \
    <div class="navItem row" data-gotoEnglish="viewEnglish" tabindex="10" data-function="changeColor">\
    ...
    <div class="navItem row" data-gotoBiology="viewBiology" tabindex="20" data-function="changeColor">\
        <div class="col-3" style="padding-top:7px;">\
...
<div class="navItem row" tabindex="30" data-function="changeColor">\
    <div class="col-3" style="padding-top:7px;">\
...
<div class="navItem row" data-gotoEnglish="viewEnglish" tabindex="30" data-function="changeColor">\
<div class="col-3" style="padding-top:7px;">\
        <img src="../img/icon_physics.png" style="height:35px;width:35px;" />\
    </div>\
    <div class="col-9" style="padding:14px;">\
...
<div id="generatedList" class="list" style="text-align:center;">\
    ...
    <div class="navItem row" data-gotoSubjectBiology="viewBiology" tabindex="10" data-function="changeColor">\
            <span style="font-size:14px;">Human anatomy</span>\
    </div>\
    <div class="navItem row" data-gotoSubjectBiology="viewBiology" tabindex="20" data-function="changeColor">\
            <span style="font-size:14px;">Genetics</span>                            </div>\
    <div class="navItem row" data-gotoSubjectBiology="viewBiology" tabindex="30" data-function="changeColor">\
...
<div id="generatedList" class="list" style="text-align:center;">\
    ...
    <div class="navItem row" id="english_focus" data-gotoSubjectDeepLayer="viewPartsOfSpeech" tabindex="10" data-function="changeColor">\
            <span style="font-size:14px;">Parts of speech</span>\
    </div>\
    <div class="navItem row" data-gotoBiologyDeepLayer="viewBiology" tabindex="20" data-function="changeColor">\
            <span style="font-size:14px;">Phrases of clauses</span>                            </div>\
    <div class="navItem row" data-gotoBiology="viewBiology" tabindex="30" data-function="changeColor">\
            <span style="font-size:14px;">Header</span>\
    </div>\
    <div class="navItem row" data-gotoBiology="viewBiology" tabindex="40" data-function="changeColor">\
            <span style="font-size:14px;">Header</span>\
    </div>\
    <div class="navItem row" data-gotoBiology="viewBiology" tabindex="50" data-function="changeColor">\
            <span style="font-size:14px;">Header</span>\
    </div>\
            </div>');
//#########english content end
